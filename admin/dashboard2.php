        ...
        <div class="flex-1 p-10">
            ...
            <div id="adminSection" class="section">
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <table class=" table-fixed min-w-full bg-white border shadow-md rounded-lg overflow-hidden border-gray-200">
                        ...
                        <tbody>
                            <tr>
                                <td class="py-4 px-6 text-center border-b border-gray-200">1</td>
                                <td class="py-4 px-6 text-center border-b border-gray-200">Admin</td>
                                <td class="py-2 px-4 text-center border-b border-gray-200">admin@gmail.com</td>
                                <td class="py-2 px-4 text-center border-b border-gray-200">03-06-1997</td>
                                <td class="py-2 px-4 text-center border-b border-gray-200">0152394872</td>
                                <td class="py-4 px-6 border-b border-gray-200 text-center">
                                    <a href="#">
                                        <button class="bg-teal-500 hover:bg-teal-600 hover:bg-blue-700  text-white font-bold py-2 px-4 rounded-md">Edit</button>
                                    </a>
                                </td>
                                <td class="py-4 px-6 border-b border-gray-200 text-center">
                                    <a href="#">
                                        <button class="bg-red-500 hover:bg-red-600 hover:bg-blue-700  text-white font-bold py-2 px-4 rounded-md">Delete</button>
                                    </a>
                                </td>
                            </tr>
                        </tbody>
